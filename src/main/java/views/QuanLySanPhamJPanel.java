...
public class QuanLySanPhamJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        tblSanPhansd.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã SP", "Tên sản phẩm ", "Loại đồ uống ", "Giá", "Đợn vị", "Trạng thái", "Hinh"
            }
        ));
        ...
        jPanel1.add(tabs);
        tabs.setBounds(10, 470, 1100, 300);
        ...
        btnPrev.setText("<<");
        jPanel1.add(btnPrev);
        btnPrev.setBounds(790, 430, 61, 32);

        btnnext.setText(">>");
        jPanel1.add(btnnext);
        btnnext.setBounds(920, 430, 61, 34);

        btnLast.setText(">|");
        jPanel1.add(btnLast);
        btnLast.setBounds(1010, 430, 61, 34);
        ...
        btnLamMoi.setBounds(960, 330, 99, 34);
        ...
        btndonvi.setBounds(600, 150, 50, 30);
        ...
        jPanel1.add(txtDV);
        txtDV.setBounds(650, 150, 190, 30);
    ...
    private void tblSanPHamksdMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblSanPHamksdMouseClicked
        ...
        if (selectedRow != -1) {
            ...
            String donvi = tblSanPHamksd.getValueAt(selectedRow, 3).toString();
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        // Input validation
        if (maSP.isEmpty() || tenSP.isEmpty() || giaStr.isEmpty() || donvi.isEmpty() || loai.isEmpty()) {
    ...
    private void btndonviActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btndonviActionPerformed
        ...
        if (newDonVi != null && !newDonVi.trim().isEmpty()) {
            txtDV.setText(newDonVi); // Assuming txtDonVi is a JTextField for unit
        }
    ...
    private void txtMaSPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtMaSPActionPerformed
        ...
        String query = "SELECT TenSP, Gia, ID_DonviSP, ID_LoaiSP, Trangthai FROM SanPham WHERE ID_Sanpham = ?";
        try {
            ...
            if (rs.next()) {
                ...
                String donvi = rs.getString("ID_DonviSP");
    ...
    private void btnLamMoiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLamMoiActionPerformed
        ...
        txtGia.setText("");
        txtDV.setText(""); // Assuming txtDonVi is a JTextField for unit
        rdosd.setSelected(true);
        loadSanPhamData(); // Tải lại dữ liệu bảng
